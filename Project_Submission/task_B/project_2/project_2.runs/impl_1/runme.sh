...
HD_PWD='C:/Users/Student/Downloads/CA project/SingleCycleRiscV/Project_Submission/task_B/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task_b_fpga_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task_b_fpga_top.tcl -notrace
