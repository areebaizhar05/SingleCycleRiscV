...
HD_PWD='C:/Users/Student/Downloads/CA project/SingleCycleRiscV/Project_Submission/task_B/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task_b_fpga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task_b_fpga_top.tcl
