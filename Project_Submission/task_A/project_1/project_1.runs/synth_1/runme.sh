...
HD_PWD='C:/Users/Student/Downloads/CA project/SingleCycleRiscV/Project_Submission/task_A/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task_a_fpga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task_a_fpga_top.tcl
