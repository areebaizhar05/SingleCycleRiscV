...
HD_PWD='C:/Users/Student/Downloads/CA project/SingleCycleRiscV/Project_Submission/task_C/project_C/project_C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task_c_fpga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task_c_fpga_top.tcl
